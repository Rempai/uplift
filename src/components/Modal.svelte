...
{#if showModal}
  <div
    on:keypress
    on:click|self
    class="fixed inset-0 z-50 overflow-y-auto bg-black/90 flex justify-center items-center pt-2">
    <div
      class="bg-night-4 p-5 rounded max-h-screen w-8/12 max-w-screen-xl overflow-y-auto border-4 border-night-3">
